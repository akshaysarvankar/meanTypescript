...
if (!exports.SENDGRID_USER) {
    logger_1.default.error("No sendgrid username. please register at https://app.sendgrid.com and provide username");
    process.exit(1);
}
if (!exports.SENDGRID_PASSWORD) {
    logger_1.default.error("No sendgrid password. Set SENDGRID_PASSWORD environment variable.");
    process.exit(1);
}
